...
@section('main')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('affiliate_level.store') }}" method="post">
                @csrf
                <div class="form-group">
                    <label for="level_name" class="col-form-label">Level name</label>
                    <input name="level_name" class="form-control" type="text" value="{{ old('level_name') }}" placeholder="" id="level_name">
                </div>
                <div class="form-group">
                    <label for="total_min" class="col-form-label">Total min</label>
                    <input name="total_min" class="form-control" type="text" value="{{ old('total_min') }}" placeholder="" id="total_min">
                </div>
                <div class="form-group">
                    <label for="total_max" class="col-form-label">Total max</label>
                    <input name="total_max" class="form-control" type="text" value="{{ old('total_max') }}" id="total_max">
                </div>

                <div class="form-group">
                    <label for="level_color" class="col-form-label">Level color</label>
                    <input name="level_color" class="form-control" type="text" value="{{ old('level_color') }}" id="level_color">
                </div>
                <div class="form-group">
