            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="frm-add-bank" method="post" action="{{ route('bank.store') }}">
                            @csrf
                            <div class="form-group">
                                <label for="">Tên Ngân hàng <span class="text-danger">*</span></label>
                                <input name="bank_name" type="text" class="form-control" id="" value="{{ old('bank_name') }}" required>
                            </div>
                            <div class="form-group">
                                <label for="">Tên tài khoản <span class="text-danger">*</span></label>
                                <input name="bank_full_name" type="text" class="form-control" id="" value="{{ old('bank_full_name') }}" required>
                            </div>
                            <div class="form-group">
                                <label for="">Số tài khoản <span class="text-danger">*</span></label>
                                <input name="bank_acc_number" type="text" class="form-control" id="" value="{{ old('bank_acc_number') }}" required>
                            </div>
                            <div class="form-group">
                                <label for="">Chi nhánh <span class="text-danger">*</span></label>
                                <input name="bank_location" type="text" class="form-control" id="" value="{{ old('bank_location') }}" required>
                            </div>
